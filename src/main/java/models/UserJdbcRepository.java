...
public class UserJdbcRepository {
	...
	public User findById(int id) {
		return jdbcTemplate.queryForObject("select * from Users where id=?", new BeanPropertyRowMapper<>(User.class),
				id);
	}
	...
	public int create(String name, String username, String password, String shipping_address, String billing_address) {
		return jdbcTemplate.update(
				"insert into Users(name, username, password, shipping_address, billing_address, admin) values(?,?,?,?,?,?)",
